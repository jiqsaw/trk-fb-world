...
function pageNavDeactive() {
    $('.pageNav').each(function () {
        ...
        $(this).attr("class", $(this).attr("class").replace("Active", "Default"));
...
function PageTabClicked(sender) {
    ...
    if (dataPage != undefined) {
        ...
        if (navClass != undefined) {
            $(".tabs nav a[data-page='" + dataPage + "']").attr("class", navClass.replace("Default", "Active"));
        }
        else {
...
function GAPush() {
    $('a').mousedown(function () {
        if ($(this).attr("data-ga") != undefined)
            GATracker($(this).attr("data-ga"));
    });
}

function GATracker(ActionName) {
    console.log("GA Tracked: " + ActionName);
